<nav class="navbar navbar-expand-lg navbar-dark fixed-top">
    ...
    <div class="container">
        ...
        <a class="navbar-brand" href="{{ route('home') }}">Netflix<span class="text-primary font-weight-bold">ify</span></a>
                        ...
                        @auth
                            <a
                                ...
                                <span class="bg-primary text-white d-flex justify-content-center align-items-center"
                                      ...
                                      id="nav__fav-count"
                                >
                                {{ auth()->user()->fav_movies_count > 9 ? '9+' : auth()->user()->fav_movies_count }}
                            </span>
                            </a>
                        @else

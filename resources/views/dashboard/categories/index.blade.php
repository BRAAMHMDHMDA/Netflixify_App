<x-dash-layout title="Categories">
    <x-slot:breadcrumb>
    ...
    <x-slot:actions>
        @can('category-create')
            <a href="{{ route('dashboard.categories.create') }}" class="btn btn-sm fw-bold btn-primary">
    ...
    <div class="card card-flush">
        <div class="card-header align-items-center py-5 gap-2 gap-md-5">
            <div class="card-title">
                ...
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <input type="text" data-kt-filter="search" class="form-control form-control-solid w-250px ps-12" placeholder="Search Category" />
                </div>
                <!--end::Search-->
        ...
        <div class="card-body pt-0">
            <table class="table align-middle table-row-dashed fs-6 gy-5  table-hover " id="category_table">
                <thead>
                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                    <th class="w-35px text-center">#</th>
                    <th class="min-w-250px">Category</th>
                    <th class="min-w-150px">Movies Count</th>

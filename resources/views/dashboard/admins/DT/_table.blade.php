<div>
    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
        <div class="card-title">
            ...
            <div class="d-flex align-items-center position-relative my-1">
                ...
                <input type="text" data-kt-filter="search" class="form-control form-control-solid w-250px ps-12" placeholder="Search Admin" />
            </div>
            <!--end::Search-->
    ...
    <div class="card-body pt-0">
        <table class="table align-middle table-row-dashed fs-6 gy-5  table-hover " id="admin_table">
            <thead>
...
@php
if (!isset($DT_route)){
    $DT_route = route('dashboard.admins.index');
}
@endphp
@push('scripts')
    <script type="text/javascript">
        ...
        // Begin::Export Buttons
        const documentTitle = 'Admins Report';

        ...
        <div class="card-body">
            ...
            <ul class="nav nav-tabs nav-line-tabs nav-line-tabs-2x border-transparent fs-4 fw-semibold mb-15">
                @foreach($menu as $nameOfGroup => $dataMenu)
                    <!--begin:::Tab item-->
                    <li class="nav-item">
                        <a class="nav-link text-active-primary d-flex align-items-center pb-5 @if($group == $nameOfGroup) active @endif"  href="{{ route('dashboard.settings.index', ['group' => $nameOfGroup])}}">
                            {!! $dataMenu['icon'] !!}
                            {{$dataMenu['name']}}
                        </a>
                    </li>
                        ...
                        @foreach($settings as $name => $setting)
                                ...
                                <div class="row fv-row mb-7">
                                    <div class="col-md-3 text-md-end">
                                        ...
                                        <label class="fs-6 fw-semibold form-label mt-3" for="{{$name}}">
                                            <span class="required">{{ $setting['label'] }}</span>
                                        </label>
                                        <!--end::Label-->
                                    </div>
                                    <div class="col-md-9">
                                        <div class="w-100">
                                            ...
                                            <select class="form-select form-select-solid"
                                                    name="{{$name}}" id="{{$name}}"
                                                    data-control="select2" data-placeholder="Select a {{$setting['label']}}"
                                            >
                            ...
                            @elseif($setting['type'] == 'textarea')
                                <div class="row fv-row mb-7">
                                    ...
                                    <div class="col-md-9">
                                        <textarea class="form-control form-control-solid" id="{{$name}}" rows="4" name="{{$name}}">{{config($name)}}</textarea>
                                     </div>
                                </div>
                            @elseif($setting['type'] == 'image')
                                <div class="row fv-row mb-7">
                                    ...
                                    <div class="col-md-9">
                                        <x-dash.form.image name="{{$name}}" old="{{ config($name) }}"/>
                                    </div>
                                </div>
